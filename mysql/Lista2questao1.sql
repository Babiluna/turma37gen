...
id INT AUTO_INCREMENT,    
 ...
 INSERT INTO tb_personagem (nome, poder_defesa, poder_ataque, agility, fk_id)  VALUES 
 ("Ghost Knight", 1000, 1000, 10000, 4);
 
 SELECT * FROM tb_personagem WHERE NAME LIKE 'c%'; 
